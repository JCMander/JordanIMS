...
public class PurchaseOrder {
  ...
  private static String FILE = fileDate + "PurchaseOrder.pdf";
  ...
  private static void createTable(Section subCatPart)
	...
	for(int i=0; i<productID.size(); i++){
		if(productQuantity.get(i)<productThreshold.get(i)){
	    	...
	    	table.addCell(Integer.toString (AppLoader.getMaxStock()[i] - (productQuantity.get(i))));
	    	table.addCell("�" + Integer.toString(productPrice.get(i)) + ".00");
	    	table.addCell("�" + Integer.toString(productPrice.get(i) * ((AppLoader.getMaxStock()[i] - (productQuantity.get(i))))) + ".00");
	    	totalPrice+=(productPrice.get(i) * ((AppLoader.getMaxStock()[i] - (productQuantity.get(i)))));
		}
	}
